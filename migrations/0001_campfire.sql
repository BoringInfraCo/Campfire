-- D1 migration 0001: derived from src/store/schema.sql (v1) + migrations.ts v2.
-- Do not edit by hand; re-derive if schema.sql changes.
...
-- Migration version 2: actor tokens + workspace invites (mirrors src/store/migrations.ts v2).
